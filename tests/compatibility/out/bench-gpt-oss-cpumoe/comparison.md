...
- Generated UTC: `2026-08-01T21:40:31Z`
- Status: `complete`
...
- Runner commit: `62273def06b52c3bd335949a20013891cc0c2a49`
...
Runner: `'C:\ProjectGrid\gridcore-runner\runner.exe' -m 'C:\ProjectGrid\models\gpt-oss-20b-MXFP4.gguf' --serve --port 55622 -c 2048 --gpu auto -n 32 --cpu-moe 20`

llama.cpp: `'C:\ProjectGrid\tools\llama-b10076\llama-server.exe' -m 'C:\ProjectGrid\models\gpt-oss-20b-MXFP4.gguf' --host 127.0.0.1 --port 55623 -c 2048 -ngl -1`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| runner | 0.92 | 0.22 | 4.32 | 0.38 | 700.8568 | 32 | 144.86 |
| llamacpp | 58.87 | 22.64 | 23.50 | 27.20 | 10.7011 | 32 | 1.25 |
...
```json
{
  ...
  "runner_after_start": [
    {
      "driver_version": "596.36",
      "memory_free_mib": 4447,
      "memory_total_mib": 8192,
      "memory_used_mib": 3572,
      "name": "NVIDIA GeForce RTX 3070"
    }
  ],
...
Maximum absolute common-token logprob delta: `1.41282365863`
...
The user says: "I want you to act as a professional copywriter. I want you to rewrite the following text in a way that is more
```
