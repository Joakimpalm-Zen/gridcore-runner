...
cd xyntetik-runner
make
./runner --version   # -> runner 0.1.19-alpha
```
...
> **Public alpha (`0.1.19-alpha`).** CI builds and smoke-tests Linux, macOS,
